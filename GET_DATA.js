 ...
 * Payload Decoder
 *
 * Inspiré de la documentation et du Github de Milesight
 *
 */
// Chirpstack v4
...
// Début de la partie de traitement dans Node-RED
if (!msg.payload || !msg.payload.length) {
    // Si le payload est vide, retourner "empty"
    ...
    // Mettre les résultats dans msg.payload
    return msg;
}
